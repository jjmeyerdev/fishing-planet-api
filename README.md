...
`wiki:enrich-species` scrapes the fish it misses (Amazonian, sharks, …) by URL,
lifting coverage to **222 of 279** fish. The rest have no wiki page, and the fields
